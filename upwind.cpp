...
void
ConvectionDiffusionNoUpwind<dim>::
...
template <typename TElem>
void
ConvectionDiffusionFullUpwind<dim>::
compute(const FV1Geometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
template <typename TElem>
void
ConvectionDiffusionWeightedUpwind<dim>::
compute(const CRFVGeometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
template <typename TElem>
void
ConvectionDiffusionSkewedUpwind<dim>::
compute(const FV1Geometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
template <typename TElem>
void
ConvectionDiffusionLinearProfileSkewedUpwind<dim>::
compute(const FV1Geometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
template <typename TElem>
void
ConvectionDiffusionPositiveUpwind<dim>::
compute(const FV1Geometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
template <typename TElem>
void
ConvectionDiffusionRegularUpwind<dim>::
compute(const FV1Geometry<TElem, dim>* geo,
        const MathVector<dim> vIPVel[maxNumSCVF],
        number vUpShapeSh[maxNumSCVF][maxNumSH],
        number vUpShapeIp[maxNumSCVF][maxNumSCVF],
...
#ifdef UG_DIM_2
template class ConvectionDiffusionNoUpwind<2>;
template class ConvectionDiffusionFullUpwind<2>;
//template class ConvectionDiffusionWeightedUpwind<2>;
template class ConvectionDiffusionSkewedUpwind<2>;
template class ConvectionDiffusionLinearProfileSkewedUpwind<2>;
template class ConvectionDiffusionPositiveUpwind<2>;
template class ConvectionDiffusionRegularUpwind<2>;
#endif

#ifdef UG_DIM_3
template class ConvectionDiffusionNoUpwind<3>;
template class ConvectionDiffusionFullUpwind<3>;
//template class ConvectionDiffusionWeightedUpwind<3>;
template class ConvectionDiffusionSkewedUpwind<3>;
template class ConvectionDiffusionLinearProfileSkewedUpwind<3>;
template class ConvectionDiffusionPositiveUpwind<3>;
template class ConvectionDiffusionRegularUpwind<3>;
#endif
