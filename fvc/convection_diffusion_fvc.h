...
#ifndef __H__UG__LIB_DISC__CONVECTION_DIFFUSION__CONVECTION_DIFFUSION_FVC__
#define __H__UG__LIB_DISC__CONVECTION_DIFFUSION__CONVECTION_DIFFUSION_FVC__
...
class ConvectionDiffusionFVC : public ConvectionDiffusionBase<TDomain>
{
	private:
	///	Base class type
	...
	///	Own type
		typedef ConvectionDiffusionFVC<TDomain> this_type;
    ...
    ///    sets the UpwindValueSource function
        void set_upwind_value_source(SmartPtr<CplUserData<number, dim> > user);
        DataImport<number, dim> m_imUpwindValue;
    ///    sets the UpwindValueSource function
...
#endif /*__H__UG__LIB_DISC__CONVECTION_DIFFUSION__CONVECTION_DIFFUSION_FVC__*/
